...
work_dir="experiments/work_dir_concat_${source}_${auxiliary}"
mkdir -p ${work_dir}

train_original_src="prefixed_data/train.en-${source}.${source}.txt"
train_original_tgt="data/train.en-${source}.en.txt"
train_auxiliary_src="prefixed_data/train.en-${auxiliary}.${auxiliary}.txt"
train_auxiliary_tgt="data/train.en-${auxiliary}.en.txt"

dev_original_src="prefixed_data/dev.en-${source}.${source}.txt"
dev_original_tgt="data/dev.en-${source}.en.txt"
dev_auxiliary_src="prefixed_data/dev.en-${auxiliary}.${auxiliary}.txt"
