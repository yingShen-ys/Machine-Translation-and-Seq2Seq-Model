...
snli_vocab = pickle.load(open('BIMPM-pytorch/snli_vocab', 'rb'))
...
print("snli vocab size:", len(snli_vocab_set))
print("iswlt vocab size:", len(iswlt_vocab_set))

print("same vocab:", same)
print("same vocab percentage in snli_vocab:", same/len(snli_vocab_set))
...
pickle.dump(iswlt_vocab, open('iswlt_xnli_snli_merged_vocab', 'wb'))
